function CBullet1(oBulletContainer,szImage,bHero){  
    var BULLET_SPEED = 3;
    ...
    this._init = function(oBulletContainer,szImage,bHero){
        ...
        //BULLET CENTER
        var oSprite = createBitmap(oImage);
        if(bHero === false){
            oSprite.scaleY = -1;
        }
        oSprite.x = -100;
        oSprite.y = -100;
        oSprite.regX = oImage.width/2;
        oSprite.regY = oImage.height/2;
        _oContainer.addChild(oSprite);
        _aSprite.push(oSprite);
